package com.wb.webbook.mongo.pagehelper;

import com.wb.webbook.exception.ParamNotNullException;
...
public class MongoPageHelper {
    ...
    public <T, R> PageResult<R> pageQuery(Query query, Class<T> entityClass, Function<T, R> mapper,
        ...
        if (pageNum== null || pageSize == null) {
            throw new ParamNotNullException("分页参数不可为空");
        }
        //分页逻辑
        ...
        final List<T> entityList = mongoTemplate
                .find(query.addCriteria(criteria)
                                .with(new Sort(Direction.ASC, ID)),
                        entityClass);
